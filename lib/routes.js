...
module.exports = {
    ...
    routes: function routes(){
        ...
        _.each(routes, function (routeObj, route) {
            ...
            if(routeObj.method && routeObj.controller){
                ...
                self.route(routeObj.method, routeObj.route, global[routeObj.controller], routeObj.action);
            }
     ...
     * @param controller
     */
    route: function route(method, route, controller, action) {
        ...
        if(action && controller && isFunction(controller[action])){
            ...
            log.silly('Route: ' + route);
            this.app[method](route, controller[method]);
        }else{
